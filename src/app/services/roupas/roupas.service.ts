...
export class RoupasService {
      ...
      .pipe(
        ...
        catchError((error: HttpErrorResponse) => {
          if (error.status === 404) {
            ...
            return throwError(
              () => new Error(`Erro ao listar roupas: ${error.message}`)
            );
          }
        })
      );
  ...
  listarTodasComPrazos(): Observable<{
    roupas: Roupas[];
      ...
      .pipe(
        ...
        catchError((error: HttpErrorResponse) => {
          if (error.status === 404) {
            ...
            return throwError(
              () =>
                new Error(`Erro ao listar roupas com prazos: ${error.message}`)
            );
          }
        })
      );
  ...
  inserir(roupa: Roupas): Observable<Roupas | null> {
    return this.http
      ...
      .pipe(
        ...
        catchError((error: HttpErrorResponse) => {
          return throwError(
            () => new Error(`Erro ao inserir roupa: ${error.message}`)
          );
        })
      );
  }
    ...
    return this.http.get<Roupas>(`${this.API}/${id}`).pipe(
      ...
      catchError((error: HttpErrorResponse) => {
        if (error.status === 404) {
          ...
          return throwError(
            () => new Error(`Erro ao buscar roupa por ID: ${error.message}`)
          );
        }
      })
    );
  ...
  atualizar(roupa: Roupas): Observable<Roupas | null> {
    return this.http
      .put<Roupas>(`${this.API}/${roupa.id}`, roupa, {
        headers: this.httpOptions.headers,
        observe: this.httpOptions.observe,
      })
      .pipe(
        ...
        catchError((error: HttpErrorResponse) => {
          return throwError(
            () => new Error(`Erro ao atualizar roupa: ${error.message}`)
          );
        })
      );
  }
  ...
  remover(id: number): Observable<void | null> {
    return this.http
      ...
      .pipe(
        ...
        catchError((error: HttpErrorResponse) => {
          return throwError(
            () => new Error(`Erro ao remover roupa: ${error.message}`)
          );
        })
      );
  }
